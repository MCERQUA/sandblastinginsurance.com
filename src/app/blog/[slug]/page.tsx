          ...
          <div className="container-tight max-w-3xl">
            <FadeIn>
              ...
              <div className="mt-12 p-7 rounded-3xl bg-espresso text-cream">
                <p className="font-heading font-extrabold text-cream text-xl">Need insurance for your sandblasting operation?</p>
                <p className="text-cream/75 mt-2 text-sm">Get a real quote in about 15 minutes — GL + CPL + WC from A-rated specialty markets.</p>
